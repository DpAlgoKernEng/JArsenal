package com.jguard.application.event.handler;
...
public class AuditLogEventHandler {
    ...
    @KafkaListener(topics = "domain-events", groupId = "jguard-audit-group", containerFactory = "stringKafkaListenerContainerFactory")
    ...
    private void handleUserRegistered(JsonNode payload) {
        ...
        AuditLog auditLog = AuditLog.success(
            userId != null ? new com.jguard.domain.user.valueobject.UserId(userId) : null,
            username != null ? new com.jguard.domain.user.valueobject.Username(username) : null,
