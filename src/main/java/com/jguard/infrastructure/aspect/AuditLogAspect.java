...
import com.jguard.domain.audit.repository.AuditLogRepository;
...
public class AuditLogAspect {
    ...
    @Around("@annotation(com.jguard.infrastructure.annotation.AuditLog)")
    public Object around(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        com.jguard.infrastructure.annotation.AuditLog auditLogAnnotation = method.getAnnotation(com.jguard.infrastructure.annotation.AuditLog.class);
    ...
    public void saveAuditLogAsync(Long userId, String username, OperationType operation,
        ...
        try {
            com.jguard.domain.audit.aggregate.AuditLog auditLog;
            if (success) {
                auditLog = com.jguard.domain.audit.aggregate.AuditLog.success(
                ...
                auditLog = com.jguard.domain.audit.aggregate.AuditLog.failure(
                    userId != null ? new UserId(userId) : null,
                    username != null ? new Username(username) : null,
                    operation, module, description, targetId,
