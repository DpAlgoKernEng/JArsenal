...
public class DataScopeInterceptor implements Interceptor {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        com.example.demo.domain.permission.entity.DataScope scope = userScope.getScope(config.getDimension());
     ...
     * 构建参数化的 WHERE 条件
     */
    public String buildParameterizedCondition(com.example.demo.domain.permission.entity.DataScope scope, DataScopeConfig config) {
     ...
     * 构建参数值
     */
    private Map<String, Object> buildScopeParameters(com.example.demo.domain.permission.entity.DataScope scope, Long userId, DataScopeConfig config) {
