...
public interface RoleMapper {
    ...
    @Results(id = "roleResult", value = {
            ...
            @Result(property = "code", column = "code", typeHandler = com.example.demo.infrastructure.persistence.converter.RoleCodeTypeHandler.class),
            @Result(property = "name", column = "name"),
            @Result(property = "parentId", column = "parent_id"),
            @Result(property = "status", column = "status", typeHandler = com.example.demo.infrastructure.persistence.converter.RoleStatusTypeHandler.class),
            @Result(property = "inheritMode", column = "inherit_mode", typeHandler = com.example.demo.infrastructure.persistence.converter.InheritModeTypeHandler.class),
