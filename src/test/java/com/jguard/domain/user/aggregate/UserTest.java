...
class UserTest {
    ...
    void rebuild_shouldHaveCorrectId() {
        ...
        User user = User.rebuild(
            new com.jguard.domain.user.valueobject.UserId(expectedId),
    ...
    void register_shouldGenerateUserRegisteredEvent() {
        ...
        assertTrue(user.pendingEvents().get(0) instanceof com.jguard.domain.user.event.UserRegistered);
    }
    ...
    void disable_shouldGenerateStatusChangedEvent() {
        ...
        // then
        assertEquals(1, user.pendingEvents().size());
        assertTrue(user.pendingEvents().get(0) instanceof com.jguard.domain.user.event.UserStatusChanged);
    }
