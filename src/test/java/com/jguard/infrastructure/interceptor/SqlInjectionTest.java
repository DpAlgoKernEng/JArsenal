...
class SqlInjectionTest {
    ...
    void shouldUseParameterizedQuery() {
        ...
        com.jguard.infrastructure.persistence.interceptor.DataScopeConfig config =
            new com.jguard.infrastructure.persistence.interceptor.DataScopeConfig("DEPARTMENT", "d", "dept_id");
